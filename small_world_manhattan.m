% Generate flexible higher-dimensional small world networks developed in
% Wang et al. (2021), "Epidemic spreading on higher-dimensional small world
% networks".
%
% Generate adjacency matrix of a version of WS small world network of any
% positive integer dimension. One way in which this code extends the
% definition of a WS small world network is that the probability p_j that a
% node j is chosen to be the target of a rewired edge can depend on
% distance d as  
